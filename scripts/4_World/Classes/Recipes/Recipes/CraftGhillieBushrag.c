...
{	
	void Init()
	{
		...
		//ingredient 2
		InsertIngredient(1,"EN5C_BurlapStrip");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("EN5C_GhillieBushrag_Tan");//add results here
