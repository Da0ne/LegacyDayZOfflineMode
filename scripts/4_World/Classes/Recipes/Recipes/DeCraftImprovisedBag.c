...
{	
	void Init()
	{
		m_Name = "Break down Improvised Bag";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"EN5C_ImprovisedBag");//you can insert multiple ingredients this way
		...
		//result2
		AddResult("EN5C_BurlapSack");//add results here
