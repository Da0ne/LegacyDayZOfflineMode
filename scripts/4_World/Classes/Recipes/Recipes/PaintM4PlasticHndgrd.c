...
{	
	void Init()
	{
		...
		//ingredient 2
		InsertIngredient(1,"EN5C_M4_PlasticHndgrd");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("EN5C_M4_PlasticHndgrd_");//add results here
