...
{	
	void Init()
	{
		m_Name = "Paint Gorka Helmet Complete";
		...
		//ingredient 2
		InsertIngredient(1,"EN5C_GorkaHelmetComplete");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("EN5C_GorkaHelmetComplete_");//add results here
