...
{	
	void Init()
	{
		m_Name = "Paint ZSh3 Pilot Helmet";
		...
		//ingredient 2
		InsertIngredient(1,"EN5C_ZSh3PilotHelmet");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("EN5C_ZSh3PilotHelmet_");//add results here
