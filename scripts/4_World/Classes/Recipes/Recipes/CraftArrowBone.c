class CraftArrowBone extends RecipeBase
{
	void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"EN5C_Ammo_ArrowPrimitive");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"EN5C_Bone");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("EN5C_Ammo_ArrowBoned");//add results here
