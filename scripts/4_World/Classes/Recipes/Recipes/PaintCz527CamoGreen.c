...
{	
	void Init()
	{
		m_Name = "Add Green Paint to Cz527";
		...
		//ingredient 2
		InsertIngredient(1,"EN5C_CZ527_Black");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("EN5C_CZ527_Camo");//add results here
