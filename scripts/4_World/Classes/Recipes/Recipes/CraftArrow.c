class CraftArrow extends RecipeBase
{
	void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"EN5C_ChickenFeather");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("EN5C_Ammo_ArrowPrimitive");//add results here
