...
{	
	void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"EN5C_WeaponCleaningKit");//you can insert multiple ingredients this way
	...
	{
		PluginRepairing module_repairing = GetPlugin(PluginRepairing);
		module_repairing.Repair(player, ingredients[0],ingredients[1],REPAIR_TYPE_CLEAN);
	}
};