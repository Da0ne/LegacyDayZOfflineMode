class PaintGhillieTopGreenMossy extends RecipeBase
{
	void Init()
	{
		...
		//ingredient 2
		InsertIngredient(1,"EN5C_GhillieTop_Mossy");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("EN5C_GhillieTop_Woodland");//add results here
