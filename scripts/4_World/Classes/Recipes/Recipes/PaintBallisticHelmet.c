...
{	
	void Init()
	{
		...
		//ingredient 2
		InsertIngredient(1,"EN5C_BallisticHelmet_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("EN5C_BallisticHelmet_");//add results here
