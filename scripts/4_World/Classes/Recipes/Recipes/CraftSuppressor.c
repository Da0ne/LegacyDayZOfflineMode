class CraftSuppressor extends RecipeBase
{
	void Init()
	{
		m_Name = "Craft Improvised Suppressor";
		...
		//ingredient 2
		InsertIngredient(1,"EN5C_DuctTape");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("EN5C_ImprovisedSuppressor");//add results here
