...
{	
	void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"EN5C_SmallStone");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"EN5C_SmallStone");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("EN5C_StoneKnife");//add results here
