...
{	
	void Init()
	{
		m_Name = "Break down Ghillie Hood";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"EN5C_GhillieHood_Tan");//you can insert multiple ingredients this way
		InsertIngredient(0,"EN5C_GhillieHood_Woodland");//you can insert multiple ingredients this way
		InsertIngredient(0,"EN5C_GhillieHood_Mossy");//you can insert multiple ingredients this way
