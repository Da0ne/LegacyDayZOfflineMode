...
{	
	void Init()
	{
		...
		//ingredient 2
		InsertIngredient(1,"EN5C_Mag_AKM_Palm30Rnd");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("EN5C_Mag_AKM_Palm30Rnd_");//add results here
	...
	{
		Magazine ingredient2 = ingredients[1];
		Magazine result = results.Get(0);
