...
{	
	void Init()
	{
		m_Name = "Clip Visor onto Gorka Helmet";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"EN5C_GorkaHelmet");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"EN5C_GorkaHelmetVisor");//you can insert multiple ingredients this way
