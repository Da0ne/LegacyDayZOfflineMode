...
{	
	void Init()
	{
		...
		//ingredient 2
		InsertIngredient(1,"EN5C_DarkMotoHelmet_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("EN5C_DarkMotoHelmet_");//add results here
