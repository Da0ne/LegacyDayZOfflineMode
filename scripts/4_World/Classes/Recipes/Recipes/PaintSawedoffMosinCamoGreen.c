...
{	
	void Init()
	{
		m_Name = "Add Green Paint to Sawedoff Mosin";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"EN5C_Spraycan_Green");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"EN5C_SawedoffMosin9130_Black");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("EN5C_SawedoffMosin9130_Camo");//add results here
