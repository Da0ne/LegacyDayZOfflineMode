...
{	
	void Init()
	{
		...
		//ingredient 2
		InsertIngredient(1,"EN5C_Mag_AK101_30Rnd");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("EN5C_Mag_AK101_30Rnd_");//add results here
