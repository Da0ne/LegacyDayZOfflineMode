...
{	
	void Init()
	{
		m_Name = "Break down Improvised Leather Bag";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"EN5C_FurImprovisedBag");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("EN5C_WoodenStick");//add results here
		...
		//result2
		AddResult("EN5C_WildboarPelt");//add results here
