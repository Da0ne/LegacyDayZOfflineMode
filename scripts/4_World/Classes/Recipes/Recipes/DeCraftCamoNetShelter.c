...
{	
	void Init()
	{
		m_Name = "Break down Camo Net Shelter";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"EN5C_CamoNetShelter");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("EN5C_LongWoodenStick");//add results here
		...
		//result2
		AddResult("EN5C_CamoNet");//add results here
