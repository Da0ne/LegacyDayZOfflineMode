...
{	
	void Init()
	{
		m_Name = "Break down Ghillie Bushrag";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"EN5C_GhillieBushrag_Tan");//you can insert multiple ingredients this way
		InsertIngredient(0,"EN5C_GhillieBushrag_Woodland");//you can insert multiple ingredients this way
		InsertIngredient(0,"EN5C_GhillieBushrag_Mossy");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("EN5C_Netting");//add results here
		...
		//result2
		AddResult("EN5C_BurlapStrip");//add results here
