...
{	
	void Init()
	{
		m_Name = "Break down Ghillie Wrap";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"EN5C_GhillieAtt_Tan");//you can insert multiple ingredients this way
		InsertIngredient(0,"EN5C_GhillieAtt_Woodland");//you can insert multiple ingredients this way
		InsertIngredient(0,"EN5C_GhillieAtt_Mossy");//you can insert multiple ingredients this way
