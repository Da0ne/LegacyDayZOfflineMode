...
{	
	void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"EN5C_Spraycan_ColorBase");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"EN5C_Mosin9130");//you can insert multiple ingredients this way
		InsertIngredient(1,"EN5C_Mosin9130_Black");//you can insert multiple ingredients this way
		InsertIngredient(1,"EN5C_Mosin9130_Green");//you can insert multiple ingredients this way
		InsertIngredient(1,"EN5C_Mosin9130_Camo");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("EN5C_Mosin9130_");//add results here
