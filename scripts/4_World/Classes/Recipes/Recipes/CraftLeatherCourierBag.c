...
{	
	void Init()
	{
		m_Name = "Craft Leather Courier Bag";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"EN5C_WildboarPelt");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"EN5C_Rope");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("EN5C_FurCourierBag");//add results here
