...
{	
	void Init()
	{
		...
		//ingredient 2
		InsertIngredient(1,"EN5C_CourierBag");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("EN5C_ImprovisedBag");//add results here
