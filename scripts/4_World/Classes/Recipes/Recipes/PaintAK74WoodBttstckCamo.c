...
{	
	void Init()
	{
		...
		//ingredient 2
		InsertIngredient(1,"EN5C_AK74_WoodBttstck_Black");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("EN5C_AK74_WoodBttstck_Camo");//add results here
