class PaintGhillieAttGreenMossy extends RecipeBase
{
	void Init()
	{
		m_Name = "Paint Ghillie Attachment";
		...
		//ingredient 2
		InsertIngredient(1,"EN5C_GhillieAtt_Mossy");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("EN5C_GhillieAtt_Woodland");//add results here
