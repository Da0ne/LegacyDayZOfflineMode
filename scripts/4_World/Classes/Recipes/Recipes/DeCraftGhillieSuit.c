...
{	
	void Init()
	{
		m_Name = "Break down Ghillie Suit";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"EN5C_GhillieSuit_Tan");//you can insert multiple ingredients this way
		InsertIngredient(0,"EN5C_GhillieSuit_Woodland");//you can insert multiple ingredients this way
		InsertIngredient(0,"EN5C_GhillieSuit_Mossy");//you can insert multiple ingredients this way
