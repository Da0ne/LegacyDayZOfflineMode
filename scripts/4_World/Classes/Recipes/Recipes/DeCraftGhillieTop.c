...
{	
	void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"EN5C_GhillieTop_Tan");//you can insert multiple ingredients this way
		InsertIngredient(0,"EN5C_GhillieTop_Woodland");//you can insert multiple ingredients this way
		InsertIngredient(0,"EN5C_GhillieTop_Mossy");//you can insert multiple ingredients this way
