...
{	
	void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"EN5C_CamoNet");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("EN5C_CamoNetShelter");//add results here
