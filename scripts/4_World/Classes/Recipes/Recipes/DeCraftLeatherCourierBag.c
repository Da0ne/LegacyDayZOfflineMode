...
{	
	void Init()
	{
		m_Name = "Break down Leather Courier Bag";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"EN5C_FurCourierBag");//you can insert multiple ingredients this way
		...
		//result2
		AddResult("EN5C_Rope");//add results here
