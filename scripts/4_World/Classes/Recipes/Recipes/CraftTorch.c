...
{	
	void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"EN5C_BandageDressing");//you can insert multiple ingredients this way
		InsertIngredient(0,"EN5C_Lard");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("EN5C_Torch");//add results here
