...
{	
	void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"EN5C_Izh43Shotgun");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("EN5C_SawedoffIzh43Shotgun");//add results here
