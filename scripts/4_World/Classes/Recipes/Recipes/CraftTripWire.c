...
{	
	void Init()
	{
		...
		//ingredient 2
		InsertIngredient(1,"EN5C_MetalWire");//you can insert multiple ingredients this way
		InsertIngredient(1,"EN5C_BarbedWire");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("EN5C_TripwireTrap");//add results here
