...
{	
	void Init()
	{
		...
		//ingredient 2
		InsertIngredient(1,"EN5C_Mag_AKM_Drum75Rnd");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("EN5C_Mag_AKM_Drum75Rnd_");//add results here
