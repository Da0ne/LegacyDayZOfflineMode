...
{	
	void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"EN5C_Mackerel");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("EN5C_MackerelFilletMeat");//add results here
		...
		//result3
		AddResult("EN5C_SmallGuts");//add results here
