...
{	
	void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"EN5C_Torch");//you can insert multiple ingredients this way
		...
		InsertIngredient(1,"EN5C_DisinfectantAlcohol");//you can insert multiple ingredients this way
	...
	bool CanDo(EntityAI ingredients[], PlayerBase player)//final check for recipe's validity
	{
		...
		if ( container.GetLiquidType2() & (GROUP_LIQUID_BLOOD | LIQUID_WATER | LIQUID_RIVERWATER | LIQUID_BEER) )
		{
			return true;
		}
		return false;
