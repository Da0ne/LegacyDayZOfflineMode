...
{	
	void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"EN5C_Worm");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"EN5C_Hook");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("EN5C_Bait");//add results here
