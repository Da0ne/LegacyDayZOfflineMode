class MissionLoader extends UIScriptedWindow
{
	...
	TStringArray		m_ListMissionsNames;
	...
	Widget Init()
	{
		...
		m_WgtLstMsnList		= (TextListboxWidget)m_WgtRoot.FindAnyWidget("wgt_lst_missions");
		m_WgtBtnMsnPlay		= (ButtonWidget)m_WgtRoot.FindAnyWidget("wgt_btn_mission_play");
		m_WgtBtnMsnClose	= (ButtonWidget)m_WgtRoot.FindAnyWidget("wgt_btn_mission_close");
