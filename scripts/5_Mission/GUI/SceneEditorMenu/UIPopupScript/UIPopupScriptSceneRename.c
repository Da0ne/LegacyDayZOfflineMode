class UIPopupScriptSceneRename extends UIPopupScript
{
	...
	{
		m_BtnOk			= wgt.FindAnyWidget("btn_ppp_sn_rnm_ok");
		m_BtnCancel		= wgt.FindAnyWidget("btn_ppp_sn_rnm_cancel");
	}
	...
	bool OnClick(Widget w, int x, int y, int button)
	{
		...
		if ( w == m_BtnOk )
		{		
			EditBoxWidget wgt_text = m_WgtRoot.FindAnyWidget("fld_ppp_sn_rnm_new_name");
