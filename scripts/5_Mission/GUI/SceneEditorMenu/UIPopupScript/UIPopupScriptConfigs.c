class UIPopupScriptConfigs extends UIPopupScript
{
	...
	{
		m_BtnOk		= wgt.FindAnyWidget("btn_ppp_pc_ok");
		m_ConfigHierarchyTextListbox = wgt.FindAnyWidget("ConfigHierarchy");
		m_ConfigVariablesTextListbox = wgt.FindAnyWidget("ConfigVariables");
		m_BtnCopyToClipboard = wgt.FindAnyWidget("btn_ppp_pc_copy");
		m_ObjectConfigFilter = wgt.FindAnyWidget("ObjectConfigFilter");
	}
