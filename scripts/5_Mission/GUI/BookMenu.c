class BookMenu extends UIScriptedMenu
{
	...
	Widget Init()
	{
		...
		m_content = layoutRoot.FindAnyWidget("HtmlWidget");
		m_author = layoutRoot.FindAnyWidget("Author"); 
		m_title = layoutRoot.FindAnyWidget("Title");
		m_page = layoutRoot.FindAnyWidget("Page");
