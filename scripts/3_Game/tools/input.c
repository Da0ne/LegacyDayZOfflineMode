...
class Input
{
	...
	*/
	...
	@param exclusive if true, returns action state and disable action for rest of frame
	...
	*/
	proto native float	GetAction(int action, bool check_focus = true, bool exclusive = false);
	
	/**
	\brief Get action state, same as GetAction() but exclusive = true
	*/
	float				GetActionExclusive(int action, bool check_focus) { return GetAction(action, check_focus, true); }
	...
	*/
	proto native bool	GetActionDown(int action, bool check_focus = true, bool exclusive = false);
	...
	@see GetActionDown()
	*/
	proto native bool	GetActionUp(int action, bool check_focus = true, bool exclusive = false);
